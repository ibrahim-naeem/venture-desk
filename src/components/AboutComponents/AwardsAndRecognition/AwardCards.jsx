    ...
    <div>
      <div className="flex mob:flex-col ltab:flex-row flex-wrap ltab:border w-[80vw] overflow-hidden mx-auto mb-20">
        <Card
          ...
          iconStyle={
            "relative -top-5 mob:left-[90%] stab:left-[43%] ltab:left-[75%] laptop:left-[73%] xl:left-12 group-hover:left-[55px] duration-300"
          }
        />
        <Card
          image={spin2}
        ...
        <Card
          ...
          Icon={MdOpenInNew}
          iconStyle={
            "relative -top-5 mob:left-[208px] laptop:left-[50px] xl:left-[208px]"
          }
        />
        <Card
          image={spin6}
