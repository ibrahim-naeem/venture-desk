    ...
    <div className="border-b-2 pb-2 w-100 ">
      <div className="flex mob:flex-col ltab:flex-row mob:px-2 ltab:px-5 ">
        ...
        <p className="mob:w-full ltab:w-1/2 mob:text-sm tab:text-lg ltab:text-xl mob:py-6 stab:py-10 ltab:py-14 laptop:py-20 mx-10  pr-20">
          At Venture Desk, bold thinking, inspired people and a passion for
          results come together for extraordinary impact. We work with clients
          who do not hide from the future but want to define it. Learn more by
          reading some of our client results stories.
        </p>
      </div>
