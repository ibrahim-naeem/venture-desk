    ...
    <div className="">
      ...
      <div className="flex justify-between mob:flex-col stab:flex-row  w-full ">
        ...
        <div className="mob:w-full ltab:w-[100%] h-40 mob:my-5 stab:my-0 stab:pr-5 ">
          <p className="border-b-[3px] text-lg font-bold">
            Featured client success story
          </p>
          <h6 className="mob:xs stab:text-sm laptop:text-base  py-5">
            “The team stood out because of their swift response time and
            patience. Cubix provided one contact person, which helped streamline
            project management and coordination. Not only did Cubix follow the
            budget and timeline, the team even offered additional services at no
            extra charge.”
          </h6>
        ...
        <div className="mob:w-full ltab:w-[100%] group h-64 mob:mb-20 ltab:mb-0">
          <p className="border-b-[3px] text-lg font-bold ">How we helped</p>
          ...
          <div className="hover:bg-slate-50 border-x border-b h-64">
            <h1 className=" h-[70px] mob:text-lg stab:text-xl laptop:text-2xl group-hover:text-base font-bold py-5 pl-5 ease-in duration-300">
            ...
            <a href="#" className="text-[#c00] font-bold pl-5 relative top-10 ">
              View Offering
            </a>
          </div>
        </div>
